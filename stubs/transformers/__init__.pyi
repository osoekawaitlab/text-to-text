...
class PreTrainedTokenizerBase:
    ...
    def __call__(self, text: str, return_tensors: str) -> Tensor: ...
...
class TextIteratorStreamer:
    def __init__(self, tokenizer: PreTrainedTokenizerBase, skip_prompt: bool, skip_special_tokens: bool): ...
    def __iter__(self) -> "TextIteratorStreamer": ...
